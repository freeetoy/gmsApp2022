...
import com.gms.app.barcode.adapter.OrderInfoData;
import com.gms.app.barcode.adapter.OrderListAdapter;
import com.gms.app.barcode.domain.OrderVO;
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (!recyclerView.canScrollVertically(1)) {
                    ...
                    new HttpAsyncTask().execute(host +  getString(R.string.api_orderList)+"searchOrderProcessCd=" + searchOrderProcessCd + "&currentPage="+currentPage++);
                }
            }
        });
    }
