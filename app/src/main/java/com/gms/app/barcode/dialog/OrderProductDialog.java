...
import com.gms.app.barcode.adapter.OrderProductAdapter;
import com.gms.app.barcode.adapter.OrderProductData;
                        ...
                        ad.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                for(int i =0 ; i < arrayList.size() ; i++){
                                    ...
                                    if(orderProductDataTemp.getTv_productId().equals(productId) && orderProductDataTemp.getTv_productPriceSeq().equals(productPriceSeq)){
                                        isAdded = true;
                                    }
                                }
                                if(isAdded){
                                    ...
                                    orderProductData = new OrderProductData(productType, productId, productCapa, productPriceSeq, strProductCount, orderProductEtc, "교환(" + bottleChangeYn + ")", bottleChangeYn, "판매(" + bottleSaleYn + ")", bottleSaleYn, "회수(" + retrievedYn + ")", retrievedYn, "AS(" + asYn + ")", asYn,0,"N", Integer.parseInt(strProductCount));
